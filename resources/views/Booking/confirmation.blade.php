...
<div class="container" ng-controller="ngCtrl">
  ...
  <div class="row">
      ...
      <div class="col l5 z-depth-3 push-l7">
    ...
    <div class='col l6 s12 pull-l5' >
      <h5>Enter Your Personal Details</h5>
      <form action="{{ route('payment') }}" method="POST" class="col s12 row">
        {{ csrf_field() }}
        <input type="hidden" name="house_id" value="{{$house->id}}" >
                <input type="hidden" name="check_in" value="{{$house->check_in}}" >
                        <input type="hidden" name="check_out" value="{{$house->check_out}}" >
        <div class="row">
